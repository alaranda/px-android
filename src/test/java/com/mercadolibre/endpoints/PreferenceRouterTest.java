...
public class PreferenceRouterTest {
  ...
  @Test
  public void initCheckout_invalidPreferenceTidySucces_500()
  ...
  @Test
  public void initCheckout_validOldPrefWithoutShipmentsNode_200()
      throws URISyntaxException, IOException {
    URIBuilder uriBuilder =
        new URIBuilder("/px_mobile/init/preference")
    ...
    MockPublicKeyAPI.getBycallerIdAndClientId(
        ...
        IOUtils.toString(
            getClass()
                .getResourceAsStream("/publicKey/TEST-d783da36-74a2-4378-85d1-76f498ca92c4.json")));
    MockPreferenceAPI.getById(
        PREF_ID_WITHOUT_SHIPMENT_NODE,
        HttpStatus.SC_OK,
        IOUtils.toString(
            getClass()
                .getResourceAsStream("/preference/dde1cff2-0a52-45ca-bc7b-bbd7360128d5.json")));
