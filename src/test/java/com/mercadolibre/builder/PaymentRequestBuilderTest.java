...
public class PaymentRequestBuilderTest {
  ...
  public void paymentBodyBuilder_preferencePayerData_bodyName() throws IOException {
    ...
    final Preference preference =
        GsonWrapper.fromJson(
            IOUtils.toString(
                getClass().getResourceAsStream("/preference/preferenceWithOnlyPayer.json")),
            Preference.class);

    final PaymentRequest paymentRequest =
        PaymentRequest.Builder.createWhiteLabelLegacyPaymentRequest(
                new Headers(), paymentRequestBody, preference, "")
            .build();
  ...
  public void paymentBodyBuilder_paymentRequestCNPJ_bodyName() throws IOException {
    ...
    final PaymentRequestBody paymentRequestBody =
        GsonWrapper.fromJson(
            IOUtils.toString(
                getClass().getResourceAsStream("/paymentRequestBody/bodyBoletoCNPJ.json")),
            PaymentRequestBody.class);
