...
public class PaymentServiceTest {
    ...
    public void getPaymentRequest_orderId_orderIdML() throws IOException, InterruptedException, ApiException, ExecutionException {
        ...
        final PaymentDataBody paymentDataBody = getObjectResponseFromFile("/paymentRequestBody/blackLabelAccountMoney.json",
    ...
    @Test
    public void getPaymentRequest_orderId_invalidOrderPayerId() throws IOException, InterruptedException, ApiException, ExecutionException {
        ...
        try {
            ...
            final PaymentRequest paymentRequest = PaymentService.INSTANCE.getPaymentRequest(CONTEXT_ES, paymentDataBody,
                    PUBLIC_KEY_BLACKLABEL_AM,"384414502", CLIENT_ID_TEST, new Headers());
    ...
    public void getPaymentRequest_merchantOrderId_merchantOrderIdMP() throws IOException, InterruptedException, ApiException, ExecutionException {
        ...
        final PaymentDataBody paymentDataBody = getObjectResponseFromFile("/paymentRequestBody/bodyAMwithPrefMerchantOrder.json",
                PaymentDataBody.class);
