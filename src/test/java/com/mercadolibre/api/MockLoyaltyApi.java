...
import static com.mercadolibre.api.LoyaltyApi.buildUrl;

public class MockLoyaltyApi {

    public static void getAsyncPoints(final CongratsRequest congratsRequest, final int statusCode, final String body) {
