...
public class MockMerchAPI {

    public static void getAsyncCrosselingAndDiscount(final CongratsRequest congratsRequest, final int statusCode, final String body) {
