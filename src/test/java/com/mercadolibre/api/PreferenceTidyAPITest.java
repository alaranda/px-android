...
public class PreferenceTidyAPITest extends RestClientTestBase {
    ...
    public void getPreferenceByKey_fail() throws IOException, RestException {
        try {
            MockPreferenceTidyAPI.getPreferenceByKey("23BYCZ", HttpStatus.SC_NOT_FOUND,
                    IOUtils.toString(getClass().getResourceAsStream("/preferenceTidy/preferenceTidyNotFound.json")));
