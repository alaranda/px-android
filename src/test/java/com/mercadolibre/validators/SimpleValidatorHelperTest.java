...
public class SimpleValidatorHelperTest {
  ...
  public void ifParamIsNotNullString_success() {
    assertThat(
        SimpleValidatorHelper.notNullString("param").validate("paramStringOK").isValid(), is(true));
  }
  ...
  public void ifParamIsNotNull_success() {
    assertThat(
        SimpleValidatorHelper.notNull("param").validate(Mockito.mock(Preference.class)).isValid(),
        is(true));
  }
  ...
  public void ifIsBigDecimalPositive_success() {
    assertThat(
        SimpleValidatorHelper.isBigDecimalPositive("param")
            .validate(new BigDecimal(11111))
            .isValid(),
        is(true));
  }
