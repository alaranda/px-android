...
public class TranslationsTest {
    ...
    @Before
    public void setUp() { this.translations = Translations.INSTANCE; }

    @Test
    public void testGetTranslationByLocale_foundKeyAndSpanish_returnsTranslatedTextInSpanish() {
        String result = this.translations.getTranslationByLocale(
    ...
    @Test
    public void testGetTranslationByLocale_foundKeyAndInvalidLanguage_returnsTranslatedTextInSpanishArg() {
    ...
    @Test
    public void testGetTranslationByLocale_foundKeyAndValidLanguageButNoTranslation_returnsTranslatedTextInSpanishArg() {
    ...
    @Test
    public void testGetTranslationByLocale_foundKeyAndInvalidLanguageButNoTranslation_returnsTranslatedTextInSpanishArg() {
