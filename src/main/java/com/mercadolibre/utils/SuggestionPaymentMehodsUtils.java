...
public final class SuggestionPaymentMehodsUtils {
  ...
  public static AlternativePayerPaymentMethod findPaymentMethodEqualsAmount(
    ...
    for (AlternativePayerPaymentMethod alternativePayerPaymentMethod :
        alternativePayerPaymentMethodList) {

      final Installment installment =
          findEqualsInstallment(
              alternativePayerPaymentMethod.getInstallments(),
              payerPaymentMethodRejected.getInstallments(),
              payerPaymentMethodRejected.getTotalAmount());

      if (null != installment) {
        alternativePayerPaymentMethodSelected =
  ...
  private static Installment findEqualsInstallment(
    ...
    for (Installment installment : installments) {
      ...
      if ((installment.getInstallments() == installmentQuantity)
          && (installment.getTotalAmount().equals(totalAmount))) {
