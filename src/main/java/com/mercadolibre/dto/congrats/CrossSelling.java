...
public class CrossSelling {
  ...
  public static class Builder {
    ...
    public Builder(
        final com.mercadolibre.dto.congrats.merch.Content content, final String iconUrl) {
      ...
      this.action =
          new Action(content.getSubtitle(), content.getActions().getContentLink().getLink());
    }
