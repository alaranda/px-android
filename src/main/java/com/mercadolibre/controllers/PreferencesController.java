  ...
  public PreferenceResponse initCheckoutByPref(final Request request, final Response response)
    ...
    try {
      ...
      final Preference preference =
          PreferenceService.INSTANCE.getPreference(context, prefId, callerId);
      final PublicKey publicKey =
          AuthService.INSTANCE.getPublicKey(
              context,
              preference.getCollectorId(),
              PreferenceService.INSTANCE.getClientId(preference.getClientId(), clientId));
