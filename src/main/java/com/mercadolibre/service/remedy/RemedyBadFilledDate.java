...
import com.mercadolibre.dto.remedy.ResponseBadFilledDate;
...
public class RemedyBadFilledDate implements RemedyInterface {
  ...
  public RemediesResponse applyRemedy(
    ...
    final String message =
        String.format(
            remediesTexts.getTranslation(context.getLocale(), KEY_MESSAGE),
    ...
    final FieldSetting fieldSetting =
        FieldSetting.builder()
            ...
            .hintMessage(
                remediesTexts.getTranslation(context.getLocale(), KEY_FIELD_SETTING_HINT_MESSAGE))
            .build();

    final ResponseBadFilledDate responseBadFilledDate =
        ResponseBadFilledDate.builder()
            .title(title)
            .message(message)
