...
public final class DatadogMetricsNames {
    ...
    public static final String REMEDIES_ALTERNATIVE_PAYMENT_METHOD = "px.checkout_mobile_payments.remedy.alternative_payment_method";
    public static final String REMEDIES_ALTERNATIVE_PAYMENT_METHOD_ESC = "px.checkout_mobile_payments.remedy.alternative_payment_method.esc";
    public static final String REMEDIES_KYC_FAIL_COUNTER = "px.checkout_mobile_payments.remedy.counter";
